...
public class UltrasonicLocalizer {
	...
	/**
	 * This is the class constructor for a class that helps to localize our robot
	 * with an ultrasonic sensor
	 * 
	 * @param leftMotor  A EV3LargeRegularedMotor object instance that allows
	 *                   control of the left motor
	 * @param rightMotor A EV3LargeRegularedMotor object instance that allows
	 *                   control of the right motor
	 * @throws OdometerExceptions
	 */
	public UltrasonicLocalizer(Navigation nav, EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor)
			throws OdometerExceptions {
	...
	/**
	 * Make the robot find North by using the rising edge, start facing left of
	 * x-axis wall
	 */
	...
	/**
	 * Make the robot find North by using the falling edge, start facing top of
	 * y-axis wall
	 */
	...
	/**
	 * Keep turning until robot is sure to have seen the wall. Takes 10 readings to
	 * be sure.
	 */
